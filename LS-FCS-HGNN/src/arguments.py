...
def get_args():
    ...
    parser.add_argument('--infer_batch_size', type=int, default=20000)
    ...
    # 
    parser.add_argument('--fanouts_0', type=int, default=20)
    parser.add_argument('--fanouts_1', type=int, default=10)
    ...
    parser.add_argument('--data_name', type=str, default='OGB_MAG')
    parser.add_argument('--query_name', type=str, default=None)
    
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument("--output_dir", type=str, default="../../../output_dir/V5/test")

    # parser.add_argument('--log', action='store_true', help='Whether to use wandb')
    args = parser.parse_args()  # 解析参数

    if args.data_name == 'OGB_MAG':
